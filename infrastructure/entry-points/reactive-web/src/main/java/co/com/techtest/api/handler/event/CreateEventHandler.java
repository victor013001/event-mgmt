...
public class CreateEventHandler {
    ...
    private final CreateEventProcessor createEventProcessors;
    ...
    public Mono<ServerResponse> handle(ServerRequest request) {
        return request.bodyToMono(CreateEventRequest.class)
                ...
                .flatMap(createEventRequest -> createEventProcessors.execute(createEventRequest, OperationType.CREATE_EVENT));
    }
